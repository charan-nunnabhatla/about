...
function App() {
  return (
    <div className="h-auto w-full overflow-hidden md:w-[70%] lg:w-[40%] xl:w-[40%] mx-auto ">
      <Hero />
      <About />
      <TechStack />
      <Projects />
      ...
      <div className="p-3 text-xs text-center text-gray-500">Last Update: Dec 2024</div>
    </div>
  );
}

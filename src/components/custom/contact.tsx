  ...
  return (
    <div id="contact" className="px-4 sm:px-6 md:px-12 lg:px-24 py-12 sm:py-16 md:py-20">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[var(--near-black)] mb-4 md:mb-6 tracking-tight">
          Get In Touch
        </h2>
        ...
        <div className="space-y-6 sm:space-y-8">
          <div className="bg-gradient-to-br from-[var(--accent-blue)]/10 to-[var(--accent-blue)]/5 rounded-2xl p-6 sm:p-8 border border-[var(--accent-blue)]/20 hover:border-[var(--accent-blue)]/40 transition-all duration-300 shadow-lg shadow-[var(--accent-blue)]/10 hover:shadow-xl hover:shadow-[var(--accent-blue)]/20">
            <ContactTile
